                  ...
                  >
                        ...
                        <div className="mt-4 flex items-center justify-center">
                              <img
                                    ...
                                    alt="Maaf, anda gagal menambahkan data perusahaan"
                        ...
                        <div className="text-center mt-4">
                              <p className="text-black">
                                    Maaf, anda{" "}
                                    <span style={{ color: "#F77D00" }}>Gagal untuk menambahkan </span>{" "}
                                    data perusahaan
                              </p>
                              <p className="font-normal"> Tolong, coba sekali lagi!</p>
                        </div>
                  </div>
            </div>
      );
