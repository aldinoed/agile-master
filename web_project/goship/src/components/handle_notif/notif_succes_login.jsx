...
const CardSuccessLogin = ({ onClose }) => {
  return (
      ...
      <div className="bg-white py-6 px-4 sm:px-6 md:px-10 rounded-lg shadow-md w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-4">
        ...
        <div className="text-center mt-4">
          <p className="text-black text-sm sm:text-base">
            Congratulations, you <span className="text-orange-500">have successfully logged in</span>
          </p>
          <p className="font-normal text-sm sm:text-base">Welcome to Goship!</p>
        </div>
      </div>
    </div>
  );
...
export default CardSuccessLogin;
