      ...
      <div className="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50 overflow-auto py-3 ">
        ...
        style={{ width: '800px', height: '500px' }}>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div className="border-l-2 border-black pl-4">
                <h2 className="text-lg font-semibold">Notification Failed</h2>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="text-center mt-4 font-bold">
            <p className="text-black">Sorry, you  {" "}
            <span style={{ color: '#F77D00'}}>failed to change your password</span>
            </p>
            <p className="font-normal"> Please, try do it again!</p>
          </div>
        </div>
      </div>
    );
